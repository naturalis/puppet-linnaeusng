...
# use certificates, place certificates in files folder of puppet manifest. Be aware of the .gitignore so certs don't end up on github!
  ...
  Hash $letsencrypt_hash        = { 'determineren' => { 'letsencrypt_domains' => ['determineren.nederlandsesoorten.nl','determinatie.nederlandsesoorten.nl']},
                                    ...
                                    'grasshoppers' => { 'letsencrypt_domains' => ['www.grasshoppersofeurope.com','grasshoppersofeurope.com','www.ortheur.org','ortheur.org']},
                                  },
...
#                                                    'ssl_key'      => '/etc/ssl/private/www_nederlandsesoorten_nl.key',
                   ...
                   'grasshoppers_alt'          => { 'proxy' => 'http://grasshoppers-frontend',
                                                    ...
                                                    'ssl'          => true,
                                                    'ssl_cert'     => '/etc/letsencrypt/live/www.grasshoppersofeurope.com/cert.pem',
