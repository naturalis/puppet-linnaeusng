...
#                                                    'ssl_key'      => '/etc/ssl/private/www_nederlandsesoorten_nl.key',
                   ...
                   'various-061_server'         => { 'proxy' => 'http://various-061',
                                                    'server_name'  => ['various-061.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-062_server'         => { 'proxy' => 'http://various-062',
                                                    'server_name'  => ['various-062.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-063_server'         => { 'proxy' => 'http://various-063',
                                                    'server_name'  => ['various-063.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-064_server'         => { 'proxy' => 'http://various-064',
                                                    'server_name'  => ['various-064.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-065_server'         => { 'proxy' => 'http://various-065',
                                                    'server_name'  => ['various-065.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-066_server'         => { 'proxy' => 'http://various-066',
                                                    'server_name'  => ['various-066.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-067_server'         => { 'proxy' => 'http://various-067',
                                                    'server_name'  => ['various-067.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-068_server'         => { 'proxy' => 'http://various-068',
                                                    'server_name'  => ['various-068.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
                                                   },
                   'various-069_server'         => { 'proxy' => 'http://various-069',
                                                    'server_name'  => ['various-069.linnaeus.naturalis.nl'],
                                                    'ssl'          => true,
                                                    'ssl_redirect' => true,
                                                    'ssl_cert'     => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl.pem',
                                                    'ssl_key'      => '/etc/ssl/private/STAR_linnaeus_naturalis_nl.key',
  ...
  Hash $upstream    = { 'various-001'               => { 'members' => ['172.16.1.160'] },
                   ...
                   'various-061'               => { 'members' => ['172.16.1.186'] },
                   'various-062'               => { 'members' => ['172.16.1.187'] },
                   'various-063'               => { 'members' => ['172.16.1.188'] },
                   'various-064'               => { 'members' => ['172.16.1.189'] },
                   'various-065'               => { 'members' => ['172.16.1.190'] },
                   'various-066'               => { 'members' => ['172.16.1.191'] },
                   'various-067'               => { 'members' => ['172.16.1.192'] },
                   'various-068'               => { 'members' => ['172.16.1.193'] },
                   'various-069'               => { 'members' => ['172.16.1.194'] },
