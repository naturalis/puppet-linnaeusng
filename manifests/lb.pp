...
# use certificates, place certificates in files folder of puppet manifest. Be aware of the .gitignore so certs don't end up on github!
  ...
  $vhost       = { 'default_server'            => { 'proxy' => 'http://default_server',
                   ...
                   'various-012_vhost'         => { 'proxy' => 'http://various-012',
                                                    'server_name' => ['various-012.linnaeus.naturalis.nl','orchidsnguinea.linnaeus.naturalis.nl','orchids.naturalis.nl'],
                                                    'ssl'         => true,
                                                    'ssl_cert'    => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl_pem',
                                                    'ssl_key'     => '/etc/ssl/private/STAR_linnaeus_naturalis_nl_key',
                                                   },
                   'various-013_vhost'         => { 'proxy' => 'http://various-013',
                                                    'server_name' => ['various-013.linnaeus.naturalis.nl','soortenregister.nl','www.soortenregister.nl','www.nederlandsesoorten.nl'],
                                                    'ssl'         => true,
                                                    'ssl_cert'    => '/etc/ssl/certs/STAR_linnaeus_naturalis_nl_pem',
                                                    'ssl_key'     => '/etc/ssl/private/STAR_linnaeus_naturalis_nl_key',
                                                   },
  ...
  $upstream    = { 'orchidsnguinea'            => { 'members' => ['172.16.1.64'] },
